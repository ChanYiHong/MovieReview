...
public class MovieController {
    ...
    @GetMapping("/read")
    public void read(@RequestParam Long id, @ModelAttribute PageRequestDTO pageRequestDTO, Model model) {
        log.info("get movie read....");

        MovieDTO result = movieService.read(id);
